def nastavit_jazyk(vybrany_jazyk: str) -> object:
  welcome_txt = {"cs": "Ahoj, vítejte ve hře Krávy a býci!", "en": "Hello, welcome to the game of Bulls and Cows!"}
  ...
  guess_num_txt = {"cs": "Hádejte číslo: ", "en": "Enter a number!"}
  ...
  new_game_status = {"cs": "Chcete novou hru? [A / Jakákoli klávesa]", "en": "Are you ready for the new game? [Y / Other key] "}
  continue_game_status = {"cs": "Moc to nejde. Chcete pokračovat? [A / Jakákoli klávesa]", "en": "Rubbish game. Do you want to continue? [Y / Other key] "}
